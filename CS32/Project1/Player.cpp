...
{
    m_age++;
	this->m_arena->history().record(m_row,m_col); //save the player's position in history
}
...
void Player::move(int dir)
{
	...
	this->m_arena->history().record(m_row,m_col); //save the player's position in history AFTER it has moved
}

bool Player::shoot(int dir)
{
    m_age++;
	this->m_arena->history().record(m_row,m_col);   //save the player's position in history. It does not matter if the command is before 
													//or after because the player does not move when shooting
