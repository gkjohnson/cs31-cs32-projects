// by Konstantin Knizhnik from http://www.garret.ru/cpp.html
#include <windows.h>
#include <stddef.h>
#include <stdio.h>
#include <math.h>
			 ...
			 WPARAM wParam, LPARAM lParam)
{
	...
	{
	  case VK_LEFT:
		kbd_queue.put(TCHAR(0xE0));
		kbd_queue.put(TCHAR('K'));
		break;
	  case VK_RIGHT:
		kbd_queue.put(TCHAR(0xE0));
		kbd_queue.put(TCHAR('M'));
		break;
	  case VK_UP:
		kbd_queue.put(TCHAR(0xE0));
		kbd_queue.put(TCHAR('H'));
		break;
	  case VK_DOWN:
		kbd_queue.put(TCHAR(0xE0));
		kbd_queue.put(TCHAR('P'));
		break;
	}
	break;
      case WM_CHAR:
